...
class Preprocessor():
    ...
    def fit(self):
        ...
        elif self.dataname == 'age':
            df = self.preprocess_age(df, 'fit')
    ...
    def transform(self, df):
        ...
        if self.dataname =='titanic':
            ...
            df = self.preprocess_age(df, 'transform')
    ...
    def preprocess_age(self, df, step='transform'):
        if step == 'fit':
            pass
        else:
            pass
